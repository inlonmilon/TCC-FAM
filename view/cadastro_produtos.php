...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#cadastroProduto').on('submit', function(event) {
            ...
            $.ajax({
                url: '../controllers/cadastrar_produto.php', // Endpoint para o cadastro
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
    ...
    $(document).on('change', '#img_prod, .img_prod', function() {
        ...
        function listarProdutos(searchTerm = '') {
            $.ajax({
                url: '../controllers/listar_produtos.php', // URL para listagem
                type: 'GET',
                data: {
                    pagina: paginaAtual,
        ...
        $(document).on('click', '.editar', function() {
            ...
            $.ajax({
                url: '../controllers/editar_produto.php',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        $(document).on('click', '.apagar', function() {
            ...
            if (confirm("Tem certeza que deseja apagar este produto?")) {
                $.ajax({
                    url: '../controllers/apagar_produto.php',
                    type: 'POST',
                    data: {
                        id: id
                    },
