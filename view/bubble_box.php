...
<head>
    ...
    <title>Produtos Bubble Box</title>
...
<body>
    ...
    <div class="container">
        <h1 class="text-center">Produtos Bubble Box</h1>
        <div class="card-container" id="bubbleBoxProductsContainer">
    ...
    <script>
        $(document).ready(function() {
            // Função para listar os produtos do tipo "bubble_box"
            function listarProdutosBubbleBox() {
                $.ajax({
            ...
            listarProdutosBubbleBox(); // Chama a função ao carregar a página

            function atualizarCards(produtos) {
                const container = $("#bubbleBoxProductsContainer");
                container.empty();
